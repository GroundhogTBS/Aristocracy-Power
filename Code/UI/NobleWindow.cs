...
{
    class NobleWindow : MonoBehaviour
    {
        ...
        public static NobleWindow instance;
        ...
        {
            contents = WindowManager.windowContents["NobleWindow"];

            scrollView = GameObject.Find(
                "Canvas Container Main/Canvas - Windows/windows/NobleWindow/Background/Scroll View"
            );
            GameObject Background = GameObject.Find(
                "Canvas Container Main/Canvas - Windows/windows/NobleWindow/Background"
            );
            ...
            instance = new GameObject("NobleWindow").AddComponent<NobleWindow>();
        ...
        {
            Windows.ShowWindow("NobleWindow");
