...
{
    class EconomicWindow : MonoBehaviour
    {
        ...
        public static EconomicWindow instance;
        ...
        {
            contents = WindowManager.windowContents["EconomicWindow"];

            scrollView = GameObject.Find(
                "Canvas Container Main/Canvas - Windows/windows/EconomicWindow/Background/Scroll View"
            );
            GameObject Background = GameObject.Find(
                "Canvas Container Main/Canvas - Windows/windows/EconomicWindow/Background"
            );
            ...
            instance = new GameObject("EconomicWindow").AddComponent<EconomicWindow>();
            ...
            int x = 30;
            int y=-10;  
            NewText("trade","#eca55f",contents.transform,new Vector3 (x,y));
            y-=10;
        ...
        {
            Windows.ShowWindow("EconomicWindow");
        ...
        public static void Ui()
        {
            ...
            {
                // 统计经济
                city.data.get("Export volume", out int ExportVolume, 0);
                city.data.get("Import volume", out int ImportVolume, 0);
                CustomNums["trade"] += ExportVolume+ImportVolume;
        ...
        {
        GameObject MRef = GameObject.Find($"/Canvas Container Main/Canvas - Windows/windows/EconomicWindow/Background/Name");
